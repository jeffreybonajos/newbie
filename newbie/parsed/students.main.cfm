...
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_body.cfm in circuit v_students which does not exist (from fuseaction v_students.body).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>

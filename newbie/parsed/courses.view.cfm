...
<cfset myFusebox.thisCircuit = "m_courses">
<cfset myFusebox.thisFuseaction = "get_course_by_id">
<cftry>
<cfoutput><cfinclude template="../model/courses/get_course_id.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 17 and right(cfcatch.MissingFileName,17) is "get_course_id.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse get_course_id.cfm in circuit m_courses which does not exist (from fuseaction m_courses.get_course_by_id).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
<!--- do action="m_teachers.Get_Teacher_List" --->
<cfset myFusebox.thisCircuit = "m_teachers">
<cfset myFusebox.thisFuseaction = "Get_Teacher_List">
...
<!--- do action="v_courses.view_form" --->
<cfset myFusebox.thisFuseaction = "view_form">
<cfsavecontent variable="body_content">
<cftry>
<cfoutput><cfinclude template="../view/courses/dsp_view_form.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 17 and right(cfcatch.MissingFileName,17) is "dsp_view_form.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_view_form.cfm in circuit v_courses which does not exist (from fuseaction v_courses.view_form).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>

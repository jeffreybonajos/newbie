...
<!--- do action="v_students.add_form" --->
<cfset myFusebox.thisFuseaction = "add_form">
<cfsavecontent variable="body_content">
<cftry>
<cfoutput><cfinclude template="../view/students/dsp_add_form.cfm"></cfoutput>
...
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_add_form.cfm in circuit v_students which does not exist (from fuseaction v_students.add_form).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
